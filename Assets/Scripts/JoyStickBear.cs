...
public class JoyStickBear : MonoBehaviour {
    ...
    public static Vector3 bearVector;
    ...
    public void Drag(BaseEventData _Data)
    {
        ...
        //조이스틱의 y값을 벡터로 변환
        bearVector = new Vector3(0, Mathf.Atan2(stickVector.x, stickVector.y) * Mathf.Rad2Deg, 0);

        player.transform.eulerAngles = bearVector;
